...
const defaultModel = 'llama-3.3-70b-specdec';
...
1. Correct the sentiment classification ("positive", "negative", "neutral") based on true user meaning (e.g. transaction failures or charges complaints are strictly negative).
