...
*   **Rate Limits & Production Scaling:**
    *   Since this demo uses Groq's **free tier**, the pipeline is designed to batch and pace requests to avoid rate limits during single-run analysis on the 660-row dataset.
